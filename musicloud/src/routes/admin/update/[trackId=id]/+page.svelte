<script lang="ts">
    ...
    const track = $derived(data?.track ?? null);
    ...
    <div class="mx-auto max-w-4xl px-6 py-10">
        <div class="rounded-2xl border border-gray-800 bg-gray-900/80 p-8 shadow-2xl shadow-black/30">
            <div class="mb-8">
                ...
                <p class="mt-2 text-sm text-gray-400">Edit the existing track details below and save your changes.</p>
            </div>
                ...
                <form method="POST" class="space-y-6" action="?/update_track" enctype="multipart/form-data">
                    <div class="grid gap-6 md:grid-cols-2">
                        ...
                        <label class="block text-sm font-medium text-gray-300">
                            ...
                            <input name="author" required value={track.author} class={inputClasses} />
                        </label>
                        ...
                        <label class="block text-sm font-medium text-gray-300">
                            ...
                            <input name="bpm" type="number" min="20" max="320" value={track.bpm ?? ''} class={inputClasses} />
                        </label>

                        <label class="block text-sm font-medium text-gray-300">
                            <span class="mb-2 block">Styles</span>
                            <input name="styles" value={stylesValue} class={inputClasses} />
                        </label>
                        ...
                        <label class="block text-sm font-medium text-gray-300 md:col-span-2">
                            ...
                            <input name="tags" value={tagsValue} class={inputClasses} />
                        </label>
                    </div>
